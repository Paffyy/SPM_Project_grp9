...
public class EventHandler : MonoBehaviour
{
    ...
    public enum EventType { DeathEvent, SpawnEvent, ArrowAoeHitEvent, DamageEvent, IsDyingEvent, RevitalizeEvent, RevitalizeZoneEvent, PickUpEvent, CheckPointEvent, CoolDownEvent, AnimTriggerEvent, BossFightTrigger, SaveEvent, LoadEvent}
